...
import pufferlib
from pufferlib.ocean.onlyfins import binding

class OnlyFins(pufferlib.PufferEnv):
...
if __name__ == '__main__':
    ...
    print('OnlyFins SPS:', int(env.num_agents*steps / (time.time() - start)))
